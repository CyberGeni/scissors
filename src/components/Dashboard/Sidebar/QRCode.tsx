        ...
        <div className='py-8 px-6 bg-gray-50 border-y'>
            ...
            <div className='flex flex-col sm:flex-row md:flex-col lg:flex-row my-6 gap-4'>
                ...
                <div className='flex flex-col w-full'>
                    ...
                    <button onClick={() => setIsQRCodeGenerated(true)} className='flex w-fit px-5 py-3 lg:my-4 rounded-md text-gray-500 border border-gray-300 bg-gray-100 shadow-[0px_1px_1px_0px_rgba(203,200,212,0.35),0px_1px_1px_1px_#FFF_inset]'>
