...
export default function ShareLinkModal({ selectedLink }: ModalProps) {
    ...
    useEffect(() => {
        if (selectedLink) {
            setShortenedUrl(selectedLink?.short_url);
        }
    }, [selectedLink])
        ...
        <>
            <div className="flex items-center justify-center">
                <button
                    type="button"
                    onClick={openModal}
                    className="w-full space-x-2 flex items-center rounded-md hover:bg-gray-200 px-4 py-3 text-sm font-medium text-gray-700 hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
                >
            ...
            <Transition appear show={isOpen} as={Fragment}>
                <Dialog as="div" className="relative z-10" onClose={closeModal}>
                    ...
                    <div className="font-circular fixed inset-0 overflow-y-auto">
                                ...
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className='text-center mx-auto my-4 space-y-4 '>
                                            <div className='flex justify-center mt-3 space-x-2 border-b border-gray-200 pb-4'>
                                                <a className='underline bg-gray-200 p-2 rounded' href={selectedLink?.short_url} target='_blank'>{selectedLink?.short_url}</a>
